...
struct Constants {
    ...
    /// Pre-sorted list of cities to avoid redundant allocations and sorting in the UI.
    /// Turkish cities are sorted with "İstanbul", "Ankara", "İzmir" at the top as preferred cities.
    static let cities: [String] = {
        ...
        return topCities + otherCities.sorted()
    }()
}
