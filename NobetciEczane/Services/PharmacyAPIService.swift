...
extension String {
    ...
    /// Optimized slugification that performs a single pass over the string.
    /// Complexity: O(N) where N is string length, avoiding multiple intermediate string allocations.
