...
struct CityPickerSheet: View {
    ...
    // Static city lists to prevent redundant sorting and allocations on every view recreation.
    ...
    private static let allCities: [String] = Self.topCities + Self.sortedCities
